    ...
    <div className="min-h-screen bg-gradient-soft flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Start your maternal care journey</p>
        </div>
        ...
        <Card className="maternal-card p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground">Join thousands of happy mothers</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.userType} onValueChange={(value) => setFormData({ ...formData, userType: value })}>
                ...
                <SelectContent>
                  <SelectItem value="patient">Expecting Mother / New Mother</SelectItem>
